...
public class TajoConf extends Configuration {
  ...
  public static enum ConfVars {
    ...
    //Internal RPC Client
    INTERNAL_RPC_CLIENT_IO_THREAD_NUM("tajo.internal.rpc.client.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 2),

    //Internal RPC Server
    MASTER_RPC_SERVER_IO_THREAD_NUM("tajo.master.rpc.server.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 2),
    QUERY_MASTER_RPC_SERVER_IO_THREAD_NUM("tajo.querymaster.rpc.server.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 2),
    WORKER_RPC_SERVER_IO_THREAD_NUM("tajo.worker.rpc.server.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 2),
    CATALOG_RPC_SERVER_IO_THREAD_NUM("tajo.catalog.rpc.server.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 2),
    SHUFFLE_RPC_SERVER_IO_THREAD_NUM("tajo.shuffle.rpc.server.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 2),

    // Client RPC
    RPC_CLIENT_IO_THREAD_NUM("tajo.rpc.client.io-thread-num", 2),

    //Client service RPC Server
    MASTER_SERVICE_RPC_SERVER_IO_THREAD_NUM("tajo.master.service.rpc.server.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 1),
    WORKER_SERVICE_RPC_SERVER_IO_THREAD_NUM("tajo.worker.service.rpc.server.io-thread-num",
        Runtime.getRuntime().availableProcessors() * 1),
