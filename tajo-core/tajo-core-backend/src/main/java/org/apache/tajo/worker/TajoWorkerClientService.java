...
public class TajoWorkerClientService extends AbstractService {
  ...
  public void init(Configuration conf) {
    ...
    try {
      ...
      int nettyWorkerNum = this.conf.getIntVar(TajoConf.ConfVars.WORKER_SERVICE_RPC_SERVER_IO_THREAD_NUM);
      this.rpcServer = new BlockingRpcServer(QueryMasterClientProtocol.class, serviceHandler, initIsa, nettyWorkerNum);
