...
public class TajoWorkerManagerService extends CompositeService
  ...
  public void init(Configuration conf) {
    ...
    try {
      ...
      int nettyWorkerNum = tajoConf.getIntVar(TajoConf.ConfVars.WORKER_RPC_SERVER_IO_THREAD_NUM);
      this.rpcServer = new AsyncRpcServer(TajoWorkerProtocol.class, this, initIsa, nettyWorkerNum);
