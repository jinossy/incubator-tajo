...
public class QueryMasterManagerService extends CompositeService
  ...
  public void init(Configuration conf) {
    ...
    try {
      ...
      int nettyWorkerNum = tajoConf.getIntVar(TajoConf.ConfVars.QUERY_MASTER_RPC_SERVER_IO_THREAD_NUM);
      this.rpcServer = new AsyncRpcServer(QueryMasterProtocol.class, this, initIsa, nettyWorkerNum);
